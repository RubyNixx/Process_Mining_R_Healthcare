...
##The Event_ID is the unique identifer which is the same for 1 patients pathway.

data <- read_excel("C:/Users/RubyNicholls/OneDrive - NHS England/Process Mining/2024_03_27 Test Data for R.xlsx", 
...
event_log <- data %>%
  eventlog(case_id = "Event_ID",
           activity_id = "Event",
           resource_id = "ORGANISATION_IDENTIFIER_CODE_OF_PROVIDER",
